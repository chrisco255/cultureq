...
class QuestContentItemDraggable extends Component {
...
// QuestContentItemDraggable = CSSModules(QuestContentItem, styles);
QuestContentItemDraggable = DragSource(QUEST_CONTENT_ITEM, dragSourceSpec, dragSourceCollect)(QuestContentItemDraggable);
QuestContentItemDraggable = DropTarget([QUEST_CONTENT_ITEM, POOL_CONTENT_ITEM], dropTargetSpec, dropTargetCollect)(QuestContentItemDraggable);
export default QuestContentItemDraggable;
